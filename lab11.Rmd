...
Answer: linear. As x increases y increases and the slope is about 1.
...
Answer: Yes the tendency is correct.
...
ggplot(birds,aes(male_mass,egg_mass))+
  ...
  scale_y_log10()+
  geom_smooth(method = "lm", color = "black", se = FALSE, linetype = "dashed", size = 0.5)+
  annotate("point", x = 218.7, y = 87, color = "red", size = 3)
```
...
ggplot(birds,aes(male_mass,egg_mass))+
  ...
  scale_y_log10()+
  geom_smooth(method = "lm", color = "black", se = FALSE, linetype = "dashed", size = 0.5)+
  annotate("point", x = 8500, y = 133.10, color = "red", size = 3)+
  ggtitle("Penguin is here")+
  annotate("text", x = 10000, y = 52, label = "Penguin")
```
