...
**Answer**: The mean of arrest_flag in crimes is 0.17. 
...
**Answer**: The mean of theft in crimes is 0.275.
...
**Answer**: The total number of theft is 38816.
...
**Answer**: Larger. The arrested rate in area 23 is higher than the average of the total area. 
...
**Answer**: Smaller. The average number of theft in area 23 is smaller than the entire region. 
...
sum(crimes$theft)/sum(area_23$num_households)*1000
```
...
**Answer**: Most points gathered around 40000 income and less than 50 theft rate. 
...
ggplot(crimes_ca, aes(median_income, theft_rate))+
  geom_point()+
  geom_text(aes(label=area_name ),color="green")
```

What is the name of the outlier?

**Answer**: Near West Side.
